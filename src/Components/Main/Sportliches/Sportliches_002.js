...
export default function () {
  return (
    <article>
      <h3>Die Könige 2020 stehen fest</h3>
      <p>
      ...
      <p>
        Im Rahmen unseres Sommerfestes wurde die Siegerehrung im kleinen Rahmen
        durchgeführt.
      </p>
      <p>
        ...
        Anner mit 93/ 92/ 91/ 90 Ringen vor seinem Bruder Paul erst in der 4.
        Deckserie mit einem Ring Unterschied den Vereinsmeistertitel.
      </p>
      <p>
        Den Wanderpokal darf für eine Saison Hans Aicher sein Eigen nennen. Er
        erzielte nach DSB-Wertung mit 54,5 Punkten, 94 Ringen und einem 48,5
        Teiler, der mit Faktor für Auflage gewertet wurde, das beste Ergebnis
        gefolgt von Klaus Werner mit 57,3 Punkte, 94 Ringe und einem 51,3 Teiler
        ohne Faktor.
      </p>
      <p>
        Nach Nennung durch 1. Schützenmeister Paul Anner dürfen die Schützen mit
        Gewehr und Pistole in der laufenden Saison Ihren Königinnen huldigen.
        Bei den Gewehrschützen geht die Königswürde an Doris Beyer mit einem
        73,2 Teiler gefolgt von Heiner Kussmann (87,7T) und Sepp Schuster jun.
        (92,1T).
      </p>
      <p>
        Die Königskette der Pistolenschützen darf für diese Saison Corinna-Maria
        Hillbrecht tragen. Sie hatte mit einem 113,8 Teiler vor Marc Beyer
        (127,0) und Paul Anner (168,7T) die ruhigste Hand. (CK)
      </p>
    </article>
  );
}
